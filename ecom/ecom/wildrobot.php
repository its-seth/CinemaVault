...
<html>
    ...
    <body>
        ...
        <section class="name-poster">
            ...
            <img class="movie-poster" src="images/wild robot poster.jpg">
        
            <div class="info-points-div">
                <p class="info-points">Released Year: 2024<br><br>
                Duration: 1h 42m<br><br>
                IMDb Rating: 8.2<br><br>
                Distributed by: Universal Picturs<br><br>
                Director: Chris Sanders.<br><br>
                Writers: Chris Sanders, Pedro Pascal<br><br>
                Stars: Lupita Nyong'o, Pedro Pascal, Kit Cornnor<br><br>
        ...
        <section class="trailer-section">
            ...
            <div class="trailer">
                <iframe width="800" height="465" src="https://www.youtube.com/embed/p_t4V9o2t-E?si=sXhQf4dJ-vKzJ1bY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>
        </section>
        <section class="btn-section">
            <button class="atc-btn" data-product-id="1">ADD TO CART </button>
        </section>
