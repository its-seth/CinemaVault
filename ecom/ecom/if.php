...
<html>
    ...
    <body>
        ...
        <section class="name-poster">
            <h1 class="movie-name">IF</h1>
            <img class="movie-poster" src="images/if.jpg">
        
            <div class="info-points-div">
                <p class="info-points">Released Year: 2024<br><br>
                Duration: 1h 44m<br><br>
                IMDb Rating: 6.4<br><br>
                Distributed by: Universal Picturs<br><br>
                Director: John Krasinski.<br><br>
                Writers: John Krasinski<br><br>
                Stars: Cailey Fleming, Ryan Reynolds, John Krasinski<br><br>
        ...
        <section class="trailer-section">
            ...
            <div class="trailer">
                <iframe width="800" height="465" src="https://www.youtube.com/embed/mb2187Z6C9Y?si=KxU7D04i4VwUeGgq" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>
        </section>
        <section class="btn-section">
            <button class="atc-btn" data-product-id="11">ADD TO CART </button>
        </section>
