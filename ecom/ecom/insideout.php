...
<html>
    ...
    <body>
        ...
        <section class="name-poster">
            <h1 class="movie-name">Inside Out</h1>
            <img class="movie-poster" src="images/inside out poster.jpeg">
        
            <div class="info-points-div">
                <p class="info-points">Released Year: 2015<br><br>
                Duration: 1h 35m<br><br>
                IMDb Rating: 8.1<br><br>
                Distributed by: Universal Picturs<br><br>
                Director: Pete Docter,Ronnie Del Carmen.<br><br>
                Writers:Pete Docter, Ronnie Del Carmen,Meg LeFauve<br><br>
                Stars: Amy Poehler, Bill Hader, Lewis Black<br><br>
        ...
        <section class="trailer-section">
            ...
            <div class="trailer">
                <iframe width="800" height="465" src="https://www.youtube.com/embed/LEjhY15eCx0?si=L4y_jY-ARjMhU-5M" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>
        </section>
        <section class="btn-section">
            <button class="atc-btn" data-product-id="9">ADD TO CART </button>
        </section>
