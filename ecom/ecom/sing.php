...
<html>
    ...
    <body>
        ...
        <section class="name-poster">
            ...
            <img class="movie-poster" src="images/sing.jpg">
        
            <div class="info-points-div">
                <p class="info-points">Released Year: 2016<br><br>
                Duration: 1h 48m<br><br>
                IMDb Rating: 7.1<br><br>
                Distributed by: Universal Picturs<br><br>
                Director: Garth Jennings, Christophe Lourdelet.<br><br>
                Writers: Garth Jennings<br><br>
                Stars: Matthew McConaughey, Reese Witherspoon, Seth MacFarlane<br><br>
        ...
        <section class="trailer-section">
            ...
            <div class="trailer">
                <iframe width="800" height="465" src="https://www.youtube.com/embed/9qPgK_u4vX8?si=9kL9m4j1-pW8P7xS" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>
        </section>
        <section class="btn-section">
            <button class="atc-btn" data-product-id="10">ADD TO CART </button>
        </section>
