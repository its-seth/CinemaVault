...
<html>
    ...
    <body>
        ...
        <section class="name-poster">
            <h1 class="movie-name">Mothers' Instinct</h1>
            <img class="movie-poster" src="images/mothers instinct.jpg">
        
            <div class="info-points-div">
                <p class="info-points">Released Year: 2024<br><br>
                Duration: 1h 34m<br><br>
                IMDb Rating: 6.3<br><br>
                Distributed by: Universal Picturs<br><br>
                Director: Benoît Delhomme.<br><br>
                Writers: Sarah Conradt, Barbara Abel<br><br>
                Stars: Jessica Chastain, Anne Hathaway, Anders Danielsen Lie<br><br>
        ...
        <section class="trailer-section">
            ...
            <div class="trailer">
                <iframe width="800" height="465" src="https://www.youtube.com/embed/05s_n_i-v1M?si=oYxWc5Tj5wXG6B4F" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>
        </section>
        <section class="btn-section">
            <button class="atc-btn" data-product-id="8">ADD TO CART </button>
        </section>
