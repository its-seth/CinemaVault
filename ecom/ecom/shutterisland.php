...
<html>
    ...
    <body>
        ...
        <section class="name-poster">
            <h1 class="movie-name">Shutter Island</h1>
            <img class="movie-poster" src="images/shutter.island.poster.jpg">
        
            <div class="info-points-div">
                <p class="info-points">Released Year: 2010<br><br>
                Duration: 2h 18m<br><br>
                IMDb Rating: 8.2<br><br>
                Distributed by: Universal Picturs<br><br>
                Director:Martin Scorsese.<br><br>
                Writers: Laeta Kalogridis, Dennis Lehane<br><br>
                Stars: Leonardo DiCaprio, Emily Mortimer, Mark Ruffalo.<br><br>
        ...
        <section class="trailer-section">
            ...
            <div class="trailer">
                <iframe width="800" height="465" src="https://www.youtube.com/embed/v8yrZSkKxTA?si=Y0x-D0uJd-G_M4_J" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>
        </section>
        <section class="btn-section">
            <button class="atc-btn" data-product-id="13">ADD TO CART </button>
        </section>
