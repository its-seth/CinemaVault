...
<html>
    ...
    <body>
        ...
        <section class="name-poster">
            <h1 class="movie-name">Sweet Home</h1>
            <img class="movie-poster" src="images/sweet home.jpg">
        
            <div class="info-points-div">
                <p class="info-points">Released Year: 2020<br><br>
                Duration: 52min<br><br>
                IMDb Rating: 7.2<br><br>
                Distributed by: Universal Picturs<br><br>
                Director: Hwang Dong-hyuk<br><br>
                Writers: Hwang Dong-hyuk<br><br>
                Stars: Song KangLee Jin-wookLee Si-young <br><br>
                Genre: Thriller, Korean Drama.
                </p>
            </div>
            <p class="description">
        ...
        <section class="trailer-section">
            ...
            <div class="trailer">
                <iframe width="800" height="465" src="https://www.youtube.com/embed/t-OqG_Mr_D8?si=w7Y1f-m-5WzX2vF5" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>
        </section>
        <section class="btn-section">
            <button class="atc-btn" data-product-id="21">ADD TO CART </button>
        </section>
