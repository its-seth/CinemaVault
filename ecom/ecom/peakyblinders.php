...
<html>
    ...
    <body>
        ...
        <section class="name-poster">
            <h1 class="movie-name">Peaky Blinders</h1>
            <img class="movie-poster" src="images/PeakyBlinders.webp">
        
            <div class="info-points-div">
                <p class="info-points">Released Year: 2013 - 2022<br><br>
                Duration: 1h<br><br>
                IMDb Rating: 8.7<br><br>
                Distributed by: Universal Picturs<br><br>
                Director: Steven Knight.<br><br>
                Writers: Christopher Nolan, Kai Bird,Martin Sherwin<br><br>
                Stars: Cillian Murphy, Paul Anderson, Sophie Rundle<br><br>
                Genre: Period Drama, Drama, History.
                </p>
            </div>
            <p class="description">
        ...
        <section class="trailer-section">
            ...
            <div class="trailer">
                <iframe width="800" height="465" src="https://www.youtube.com/embed/oVzVdvGUn_4?si=2e3xMvUf3o5G_Z5s" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>
        </section>
        <section class="btn-section">
            <button class="atc-btn" data-product-id="17">ADD TO CART </button>
        </section>
