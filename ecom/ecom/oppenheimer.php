...
<html>
    ...
    <body>
        ...
        <section class="name-poster">
            <h1 class="movie-name">Oppenheimer</h1>
            <img class="movie-poster" src="images/oppenheimer.jpg">
        
            <div class="info-points-div">
                <p class="info-points">Released Year: 2016<br><br>
                Duration: 3h<br><br>
                IMDb Rating: 8.3<br><br>
                ...
                Stars: Cillian Murphy, Emily Blunt, Matt Damon<br><br>
        ...
        <section class="trailer-section">
            ...
            <div class="trailer">
                <iframe width="800" height="465" src="https://www.youtube.com/embed/uYPbbksJxIg?si=J_v418FVuDYQkCdb" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>
        </section>
        <section class="btn-section">
            <button class="atc-btn" data-product-id="14">ADD TO CART </button>
        </section>
