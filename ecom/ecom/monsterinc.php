...
<html>
    ...
    <body>
        ...
        <section class="name-poster">
            <h1 class="movie-name">Wild Robot</h1>
            <img class="movie-poster" src="images/monster inc.jpeg">
        
            <div class="info-points-div">
                <p class="info-points">Released Year: 2001<br><br>
                Duration: 1h 32m<br><br>
                IMDb Rating: 8.1<br><br>
                Distributed by: Universal Picturs<br><br>
                Director: Pete Docter, David Silverman, Lee Unkrich.<br><br>
                Writers: Garth Jennings.<br><br>
                Stars: Pete Docter, Jill Culton, Jeff Pidgeon.<br><br>
        ...
        <section class="trailer-section">
            ...
            <div class="trailer">
                <iframe width="800" height="465" src="https://www.youtube.com/embed/cvOQeozL4S0?si=L43L9R5WJ1r_vC-v" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>
        </section>
        <section class="btn-section">
            <button class="atc-btn" data-product-id="5">ADD TO CART </button>
        </section>
