...
<html>
    ...
    <body>
        ...
        <section class="name-poster">
            ...
            <img class="movie-poster" src="images/moana.jpg">
        
            <div class="info-points-div">
                <p class="info-points">Released Year: 2016<br><br>
                Duration: 1h 47m<br><br>
                IMDb Rating: 7.6<br><br>
                Distributed by: Universal Picturs<br><br>
                Director: Ron Clements, John MuskerDon Hall.<br><br>
                Writers: Jared Bush, Ron Clements, John Musker<br><br>
                Stars: Auli'i Cravalho, Dwayne Johnson, Rachel House<br><br>
        ...
        <section class="trailer-section">
            ...
            <div class="trailer">
                <iframe width="800" height="465" src="https://www.youtube.com/embed/LKFuXETZUsI?si=sXb2oD-f1-2gH7kC" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>
        </section>
        <section class="btn-section">
            <button class="atc-btn" data-product-id="12">ADD TO CART </button>
        </section>
