...
<html>
    ...
    <body>
        ...
        <section class="name-poster">
            <h1 class="movie-name">Forgotten</h1>
            <img class="movie-poster" src="images/forgotten.jpg">
        
            <div class="info-points-div">
                <p class="info-points">Released Year: 2017<br><br>
                Duration: 1h 48m<br><br>
                IMDb Rating: 7.4<br><br>
                Distributed by: Universal Picturs<br><br>
                Director: Jang Hang-jun.<br><br>
                Writers: Kang Ha-neul, Kim Mu-yeol, Moon Sung-keun<br><br>
        ...
        <section class="trailer-section">
            ...
            <div class="trailer">
                <iframe width="800" height="465" src="https://www.youtube.com/embed/DBgTMV_e-o0?si=m5S8bO2g7X1J0_q1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>
        </section>
        <section class="btn-section">
            <button class="atc-btn" data-product-id="16">ADD TO CART </button>
        </section>
